<?php
 class Playlist{
     ...
     public function __construct($con, $data){ // data is passing in query result
        if (!is_array($data)){
     ...
     public static function getPlaylistDropdown($con, $username){ // static - call it without cerating instnaces of this class
          $dropdown = ' 
     <select class="items playlist">
